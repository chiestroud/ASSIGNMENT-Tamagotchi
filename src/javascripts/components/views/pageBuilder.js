const pageBuilder = () => {
  document.querySelector('#progress').innerHTML = `<div class="container header">
                                                     <h1 class="title"><span class="container secret-image" id="secretImg"></span><i class="fas fa-trophy left"></i> TAMAGOTCHI たまごっち <i class="fas fa-trophy right"></i><span class="container secret-image" id="secretImg2"></span></h1>
                                                     <div class="barContainer">
                                                     <div class="progress-bar" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width:70%" id="average">WELCOME TO THE WEBSITE<span class="sr-only">%</span></div>
                                                     </div>
                                                     </div>
                                                    </div>`;
  ...
  document.querySelector('#pet').innerHTML = `<div class="formContainer">
